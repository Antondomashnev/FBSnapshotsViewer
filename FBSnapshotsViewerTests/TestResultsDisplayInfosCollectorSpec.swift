...
class TestResultsDisplayInfosCollectorSpec: QuickSpec {
    override func spec() {
        ...
        let build1 = Build(date: Date(timeIntervalSinceNow: -300), applicationName: "FBSnapshotsViewer")
        let build2 = Build(date: Date(timeIntervalSinceNow: -500), applicationName: "AmazingWeather")
        let build3 = Build(date: Date(timeIntervalSinceNow: -700), applicationName: "FBSnapshotsViewer")
