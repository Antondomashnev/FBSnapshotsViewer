    ...
    override func spec() {
        ...
        describe(".canView") {
            ...
            context("for recorded snapshot test result") {
                beforeEach {
                    testResult = SnapshotTestResult.recorded(testName: "testName", referenceImagePath: "foo/bar/referenceImage.png", createdAt: Date())
                }
            ...
            context("for failed snapshot test result") {
                beforeEach {
                    testResult = SnapshotTestResult.failed(testName: "testName", referenceImagePath: "foo/bar/referenceImage.png", diffImagePath: "foo/bar/diffImage.png", failedImagePath: "foo/bar/failedImage.png", createdAt: Date())
                }
