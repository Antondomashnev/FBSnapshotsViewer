...
class TestResultsCollectionViewOutletsSpec: QuickSpec {
    override func spec() {
        ...
        describe(".numberOfItemsInSection") {
            ...
            beforeEach {
                let snapshotTestResult = SnapshotTestResult.failed(testName: "testName", referenceImagePath: "referenceImagePath.png", diffImagePath: "diffImagePath.png", failedImagePath: "failedImagePath.png", createdAt: Date())
