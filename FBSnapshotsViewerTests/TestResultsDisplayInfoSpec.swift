    ...
    override func spec() {
        ...
        describe(".init") {
            beforeEach {
                ...
                let testInformation = SnapshotTestInformation(testClassName: "Bar", testName: "foo_name", testFilePath: "/foo/Bar.m", testLineNumber: 1)
                let testResultInfo1 = TestResultDisplayInfo(testResult: SnapshotTestResult.recorded(testInformation: testInformation, referenceImagePath: "foo/bar.png", build: build1))
                let testResultInfo2 = TestResultDisplayInfo(testResult: SnapshotTestResult.recorded(testInformation: testInformation, referenceImagePath: "foo/bar.png", build: build2))
                let testResultInfo3 = TestResultDisplayInfo(testResult: SnapshotTestResult.recorded(testInformation: testInformation, referenceImagePath: "foo/bar.png", build: build3))
                let testResultInfo4 = TestResultDisplayInfo(testResult: SnapshotTestResult.recorded(testInformation: testInformation, referenceImagePath: "foo/bar.png", build: build3))
