  ...
  module Actions
    ...
    class SparkleAddUpdateAction < Action
      ...
      def self.run(params)
        ...
        item.add_element("description").add_text(params[:description])
      ...
      def self.available_options
        [
          ...
          FastlaneCore::ConfigItem.new(key: :description,
                                       env_name: "FL_SPARKLE_ADD_DESCRIPTION",
                                       description: "Update release description",
                                       verify_block: proc do |value|
                                          raise "Invalid release description '#{value}'".red unless (value and !value.empty?)
                                       end),
